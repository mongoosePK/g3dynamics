...
@section('page_header')
    <h1 class="page-title">
        ...
        {{ __('voyager::generic.'.(isset($dataTypeContent->id) ? 'edit' : 'add')).' Account' }}
    </h1>
@stop
...
@section('content')
    <div class="page-content container-fluid">
        <form class="form-edit-add" role="form"
              action="{{ (isset($dataTypeContent->id)) ? route('voyager.account.update', [$dataTypeContent->id]) : route('voyager.account.store') }}"
                ...
                <div class="col-md-8">
                    ...
                    {{-- <div class="panel"> --}}
                        ...
                        <div class="panel-body">
                            ...
                            <div class="form-group">
                                <label for="password">Passowrd Confirmation: </label>
        ...
        <form id="my_form" action="{{ route('voyager.upload') }}" target="form_target" method="post" enctype="multipart/form-data" style="width:0px;height:0;overflow:hidden">
            ...
            <input type="hidden" name="type_slug" id="type_slug" value="account">
        </form>
    </div>
@stop
