...
<div class="container col-12 col-lg-9">
    @if (Session::has('success'))
        <div class="col alert alert-success">{{ Session::get('success') }}</div>
    @endif
    <div class="col-12 page-title"><h2>{{ $page->title }}</h2></div>
        
    <div class="col-12 post-image"><img src="storage/{{ $page->image }}"/></div>
    ...
    <div class="container-fluid page-body">
        <ul class="nav nav-tabs" id="nav-tab" role="tablist">
            ...
            <li class="nav-item">
                <a class="nav-item nav-link" data-toggle="tab" href="#register" 
                role="tab" aria-controls="register" aria-selected="false">Register</a>
            </li>
            <li class="nav-item">
                <a class="nav-item nav-link" data-toggle="tab" href="#rules" 
                role="tab" aria-controls="rules" aria-selected="false">Rules</a>
            </li>
            <li class="nav-item">
                <a class="nav-item nav-link qa-tab" data-toggle="tab" href="#qa" 
                role="tab" aria-controls="qa" aria-selected="false">Q & A</a>
            </li>
            <li class="nav-item">
                <a class="nav-item nav-link" data-toggle="tab" href="#aar" 
                role="tab" aria-controls="aar" aria-selected="false">AAR</a>
            </li>
        </ul>
    </div>
    <div class="tab-content container-fluid">
        <div class="tab-pane fade show active" id="info" role="tabpanel" aria-labelledby="info-tab">
            ...
            <div class="col-12 page-container contest-text">
                {!! $page->body !!}
                * $6.95 shipping and handling applies to each address
            </div>
            <div class="container-fluid page-body">
                <ul class="nav nav-tabs justify-content-center" id="info-tabs" role="tablist">
                    <li class="nav-item">
                        <a class="nav-item nav-link active" data-toggle="tab" href="#toughman" 
                        role="tab" aria-controls="toughman" aria-selected="true">Tough-man</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-item nav-link" data-toggle="tab" href="#regular" role="tab" 
                        aria-controls="register" aria-selected="false">Regular</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-item nav-link" data-toggle="tab" href="#open" role="tab" 
        ...
        <div class="tab-content container-fluid">
            ...
            <div class="tab-pane fade" id="register" role="tabpanel" aria-labelledby="register-tab">
                @if ($user)
                    ...
                    @if($amount == 0 && $pre == false)
                        <div class="container">
                            <div class="col-12 page-title"><h2>Your team has completed the registration process, Thank you for registering!</h2></div>
                        </div>
                    @endif
            ...
            <div class="tab-pane fade" id="aar" role="tabpanel" aria-labelledby="aar-tab">
                <div class="col-12 page-container aar-container">
