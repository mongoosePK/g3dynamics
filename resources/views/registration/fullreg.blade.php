<div class="container-fluid contest-text">
        ...
        <div class="col-12 float-left input-container">
        ...
        <div class="col-12 float-left">
            ...
            <div class="col-12 col-md-4 float-left input-container">
                {!! Form::text('member1_first_name', $user->first_name, array('class' => 'sponsor-input form-control $error', 'placeholder' => 'First Name *')) !!}
            ...
            <div class="col-12 col-md-4 float-left input-container">
                    {!! Form::text('member1_last_name', $user->last_name, array('class' => 'sponsor-input form-control $error', 'placeholder' => 'Last Name *')) !!}
            ...
            <div class="col-12 col-md-4 float-left input-container">
                    {!! Form::text('member1_phone', '', array('class' => 'sponsor-input form-control $error', 'placeholder' => 'Phone *')) !!}
            ...
            <div class="col-12 float-left input-container">
                    ...
                    {!! Form::text('member1_address', '', array('class' => 'sponsor-input form-control $error', 'placeholder' => 'Street Address *')) !!}
                    @if ($errors->has('member1_address'))
                        <span class="has-error">{{ $errors->first('member1_address') }}</span>
                    @endif
            </div>

            <div class="col-5 col-md-7 float-left input-container">
                    {!! Form::text('member1_city', '', array('class' => 'sponsor-input form-control $error', 'placeholder' => 'City *')) !!}
                    @if ($errors->has('member1_city'))
                        <span class="has-error">{{ $errors->first('member1_city') }}</span>
                    @endif
            </div>

            <div class="col-3 col-md-2 float-left input-container">
                    {!! Form::select('member1_state', [  '' => 'State *', 'AL' => 'Alabama', 'AK' => 'Alaska', 'AZ' => 'Arizona', 'AR' => 'Arkansas',
            ...
            <div class="col-4 col-md-3 float-left input-container">
                    {!! Form::text('member1_zip', '', array('class' => 'sponsor-input form-control $error', 'placeholder' => 'Zip Code *')) !!}
            ...
            <div class="col-12 col-md-4 float-left input-container">
                    {!! Form::text('member1_email', $user->email, array('class' => 'sponsor-input form-control $error', 'placeholder' => 'Email *')) !!}
                    @if ($errors->has('member1_email'))
                        <span class="has-error">{{ $errors->first('member1_email') }}</span>
                    @endif
            </div>

            <div class="col-6 col-md-4 float-left input-container">
                    {!! Form::select('member1_size', [  '' => 'Shirt Size *', 'Small' => 'Small', 'Medium' => 'Medium', 'Large' => 'Large', 'X-Large' => 'X-Large',
            ...
            <div class="col-6 col-md-4 float-left input-container">
                    {!! Form::select('member1_pastcompetitor', [  '' => 'Past Competitor? *', 'No' => 'No', 'Yes' => 'Yes'], null, array('class' => 'past-comp-m1 sponsor-input form-control one-whole')) !!}
                    @if ($errors->has('member1_pastcompetitor'))
                        <span class="has-error">{{ $errors->first('member1_pastcompetitor') }}</span>
                    @endif
            </div>

            <div class="col-6 float-left input-container past-comp-years pastcomp_m1">
        ...
        <div class="container float-left">
            ...
            <div class="col-12 col-md-4 float-left input-container">
                    {!! Form::text('member2_first_name', '', array('class' => 'sponsor-input form-control $error', 'placeholder' => 'First Name *')) !!}
            ...
            <div class="col-12 col-md-4 float-left input-container">
                    {!! Form::text('member2_last_name', '', array('class' => 'sponsor-input form-control $error', 'placeholder' => 'Last Name *')) !!}
            ...
            <div class="col-12 col-md-4 float-left input-container">
                    {!! Form::text('member2_phone', '', array('class' => 'sponsor-input form-control $error', 'placeholder' => 'Phone *')) !!}
            ...
            <div class="col-12 float-left input-container">
                    {!! Form::text('member2_address', '', array('class' => 'sponsor-input form-control $error', 'placeholder' => 'Street Address *')) !!}
            ...
            <div class="col-5 col-md-7 float-left input-container">
                    {!! Form::text('member2_city', '', array('class' => 'sponsor-input form-control $error', 'placeholder' => 'City *')) !!}
            ...
            <div class="col-3 col-md-2 float-left input-container">
                    {!! Form::select('member2_state', [  '' => 'State *', 'AL' => 'Alabama', 'AK' => 'Alaska', 'AZ' => 'Arizona', 'AR' => 'Arkansas',
                                            'CA' => 'California', 'CO' => 'Colorado', 'CT' => 'Connecticut',
                                            'DE' => 'Delaware', 'DC' => 'District Of Columbia', 'FL' => 'Florida',
                                            'GA' => 'Georgia', 'HI' => 'Hawaii', 'ID' => 'Idaho', 'IL' => 'Illinois',
                                            'IN' => 'Indiana', 'IA' => 'Iowa', 'KS' => 'Kansas', 'KY' => 'Kentucky',
            ...
            <div class="col-4 col-md-3 float-left input-container">
                    {!! Form::text('member2_zip', '', array('class' => 'sponsor-input form-control $error', 'placeholder' => 'Zip Code *')) !!}
            ...
            <div class="col-12 col-md-4 float-left input-container">
                    {!! Form::text('member2_email', '', array('class' => 'sponsor-input form-control $error', 'placeholder' => 'Email *')) !!}
            ...
            <div class="col-6 col-md-4 float-left input-container">
                    {!! Form::select('member2_size', [  '' => 'Shirt Size *', 'Small' => 'Small', 'Medium' => 'Medium', 'Large' => 'Large', 'X-Large' => 'X-Large',
                                            '2X-Large' => '2X-Large', '3X-Large' => '3X-Large'
                                            ], null, array('class' => 'sponsor-input form-control one-whole')) !!}
            ...
            <div class="col-6 col-md-4 float-left input-container">
                    {!! Form::select('member2_pastcompetitor', [  '' => 'Past Competitor? *', 'No' => 'No', 'Yes' => 'Yes'], null, array('class' => 'past-comp-m2 sponsor-input form-control one-whole')) !!}
                    @if ($errors->has('member2_pastcompetitor'))
                        <span class="has-error">{{ $errors->first('member2_pastcompetitor') }}</span>
                    @endif
            </div>

            <div class="col-6 float-left input-container past-comp-years pastcomp_m2">
        ...
        <div class="col-12 float-left">
            ...
            <div class="col-6 float-left input-container">
            ...
            <div class="col-4 float-left input-container">
            ...
            <div class="col-4 float-left input-container">
                    {!! Form::select('cc_expire_year', [  '' => 'Exp. Year *', '2018' => '2018', '2019' => '2019', '2020' => '2020', '2021' => '2021',
